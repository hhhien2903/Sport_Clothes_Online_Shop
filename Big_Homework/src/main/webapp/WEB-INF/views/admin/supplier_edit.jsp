							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form:form method="POST" action="edit" modelAttribute="supplier" class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-2 control-label">Mã Nhà Cung Cấp:</label>
												<div class="col-sm-10">
													<form:input readonly="true" value="${supplierInDB.supplierID}" path="supplierID" class="form-control"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">Tên Nhà Cung Cấp:</label>
												<div class="col-sm-10">
													<form:input path="supplierName" value="${supplierInDB.supplierName}" placeholder="Tên Nhà Cung Cấp" class="form-control"/>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="supplierEmail" value="${supplierInDB.supplierEmail}" placeholder="Email Nhà Cung Cấp" class="form-control"/>
