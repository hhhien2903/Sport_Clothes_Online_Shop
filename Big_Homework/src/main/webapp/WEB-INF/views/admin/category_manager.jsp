				...
				<div class="col-md-12">
						...
						<div class="row" style="margin-bottom: 20px">
							<div class="col-md-4 col-md-offset-8">
								<form method="GET" action="<c:url value = "/admin/category/search"/>">
										...
										<table class="table table-bordered table-striped">
											...
											<c:forEach items="${list}" var="listItem" varStatus="loop">
												<tr>
													...
													<td style="text-align: center;"><a href="<c:url value="/admin/category/edit?categoryID=${listItem.categoryID}"/>" class="btn btn-primary" style="padding: 5px 10px; font-size: 15px;"><i class="fas fa-edit"></i></a></td>
													<td style="text-align: center;"><a href="<c:url value="/admin/category/delete?categoryID=${listItem.categoryID}"/>" class="btn btn-danger" style="padding: 5px 10px; font-size: 15px;"><i class="fas fa-trash-alt"></i></a></td>
