							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form:form method="POST" action="add" modelAttribute="category" class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-2 control-label">Tên Danh Mục:</label>
												<div class="col-sm-10">
													<form:input path="categoryName" placeholder="Tên Danh Mục" class="form-control"/>
